...
define('REGISTER_NUMBER','Numéro de téléphone :');
define('REGISTER_PASSWORD','Mot de passe :');
define('REGISTER_ADDRESS','Adresse 1 :');
...
define('REGISTER_SUBMIT','Valider mes informations');
//Erreur
...
define('ERROR_NUMBER','Erreur dans la saisie du prénom');
define('ERROR_PASSWORD','Erreur dans la saisie du mot de passe');
define('ERROR_ADDRESS','Erreur dans la saisie du prénom');
define('ERROR_POSTALCODE','Erreur du code postal');
define('ERROR_CITY','Erreur dans la saisie de la ville');
define('USER_CONNECTION_SUCCESS','Connecté avec succès');
define('ERROR_REGISTER_PASSWORD_VERIFY','Erreur dans la saisie du mot de passe:');
