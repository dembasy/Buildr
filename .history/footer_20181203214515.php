...
<?php if ($_SERVER['PHP_SELF'] == '/index.php') { ?>
    <footer class=" font-small blue-grey white">
        <div style="background-color: blue;" class="footer-style">
            <div class="container">
                <div class="row py-4 d-flex align-items-center">
                    <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
                        <h6 class="mb-0 text-white">Suivez nous sur nos réseaux sociaux!</h6>
                    </div>
                    <div class="col-md-6 col-lg-7 text-center text-md-right">
                        <a class="fb-ic"><i class="fab fa-facebook white-text mr-4"> </i></a>
                        <a class="tw-ic"><i class="fab fa-twitter white-text mr-4"> </i></a>
                        <a class="gplus-ic"><i class="fab fa-google-plus white-text mr-4"> </i></a>
                        <a class="li-ic"><i class="fab fa-linkedin white-text mr-4"> </i></a>
        ...
        <div class="footer-copyright text-center text-black-50 py-3">© 2018 Tous droits réservées:
            <a class="dark-grey-text" href="https://buildr.io/"> Buildr.io</a>
        </div>
    </footer>
<?php } ?>
<!-- JQuery -->
