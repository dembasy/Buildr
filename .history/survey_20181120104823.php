		...
		<div class="col-sm-12">
			<div class="mm-survey">
                ...
                <div class="mm-survey-question">
								...
								<div class="mm-survey-item">
									<input type="radio" id="radio07" data-item="4" />
									<label for="radio07"><span></span><p>Moins de 10 000€</p></label>
								</div>
								<div class="mm-survey-item">
									<input type="radio" id="radio08" data-item="4" name="radio4"/>
									<label for="radio08"><span></span><p>Entre 10 000 et 30 000€</p></label>
								</div>
								<div class="mm-survey-item">
									<input type="radio" id="radio19" data-item="4" name="radio4"/>
									<label for="radio19"><span></span><p>Entre 30 000 et 100 000€</p></label>
								</div>
								<div class="mm-survey-item">
									<input type="radio" id="radio22" data-item="4" name="radio4"/>
