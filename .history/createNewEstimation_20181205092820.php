            ...
            <form action="#" method="POST">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?> placeholder="La maison des Dupont"  />
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="area" <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?> placeholder="Surface en m²" name="area" />
                    ...
                    <div class="form-group">
                        ...
                        <input id="address" name="address" class="form-control form-control-alternative " <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?> type="text" />
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="postalCode" id="postalCode" <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?> class="form-control form-control-alternative" />
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <span class="mb-2">Quelle est votre budget ?</span><br>
                                <label class="form-control-label mt-2" for="startBudget">Entre</label><br>
                                <input type="number" name="startBudget" id="startBudget" <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?> class="form-control form-control-alternative" type="number" />
                                <p class="text-danger"><?= isset($errorList['startBudget']) ? $errorList['startBudget'] : ''; ?></p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group"><br>
                                <label class="form-control-label mb-3" for="endBudget"> ET</label>                 
                                <input type="number" name="endBudget" id="endBudget" <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?> class="form-control form-control-alternative" class="col" />
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?> id="exampleTextarea" rows="3" name="moreInfos"></textarea>
                    </div>
