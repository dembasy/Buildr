    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://buildr/login-register/loginPro.php"><i class="fas fa-wrench fa-style"></i> Espace Pro</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="http://buildr/login-register/login.php"><i class="far fa-user-circle fa-style"></i> Espace Client</a>
          </li>       
        </ul>
      </div>
    </nav>
    <div class="view intro-2">
        <div class="flex-center">
          <div class="container text-left white-text wow fadeInUp">
            <h2 class="brand-size mb-2">Buildr</h2>
