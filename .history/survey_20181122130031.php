                        ...
                        <form action="#" method="POST">
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group has-error">
                                            <label class="form-control-label mb-2" for="rooms">Quelles pièces voulez vous renover ?</label> <br>
                                            <p class="text-danger"><?= isset($errorList['rooms']) ? $errorList['room'] : ''; ?></p>
                                            <select name = "rooms" id = "rooms" >
                                                <option selected disabled></option>
                                                <?php foreach ($roomsList as $roomsListName) { ?>
                                                    <option value="<?= $idRoomsDetails->id ?>"><?= $idRoomsDetails->type ?></option>
                                                    <?php }
                                                ?>
                                            </select>
                                        </div>
