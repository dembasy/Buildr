    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://buildr/dashboard/loginPro.php"><i class="fas fa-wrench fa-style"></i> Espace Pro</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="http://buildr/dashboard/login.php"><i class="far fa-user-circle fa-style"></i> Espace Client</a>
          </li>       
        </ul>
      </div>
    </nav>
