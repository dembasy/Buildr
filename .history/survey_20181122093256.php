                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group has-error">
                                    ...
                                    <select name = "room" id = "name" >
                                      <option selected disabled>Veuillez séléctionner votre choix</option>
                                        <option name="name" value="1">Salle de bains</option>
                                        <option name="name" value="2">Cuisine</option>
                                        <option name="name" value="3">Chambres</option>
                                        <option name="name" value="4">Garages</option>
                                        <option name="name" value="5">Chambres d'hôtes</option>
                                        <option name="name" value="5">Rénovation complète</option>
                                    </select>
                                </div>
                            </div>
                        </div>
