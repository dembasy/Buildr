                        ...
                        <form action="#" method="POST">
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group has-error">
                                            <label class="form-control-label mb-2" for="startBudget">Quel est votre budget ?</label><br>                                            <p class="text-danger"><?= isset($errorList['budget']) ? $errorList['budget'] : ''; ?></p>
                                            Entre <input class="col" type="number">
