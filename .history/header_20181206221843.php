      ...
      <ul class="nav navbar-nav nav-flex-icons ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
              <ul>
                          <li class="dropdown-toggle" data-toggle="dropdown" href="#"><a class="dropdown-item" href="<?= $_SERVER['PHP_SELF'] ?>?action=disconnect"><i class="fas fa-sign-out-alt"></i> <?= NAV_DISCONNECT ?></a></li>
