            ...
            <form action="#" method="POST">
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="form-control-label" for="startBudget">Quelle est votre budget ?</label><br>
                                <span class="mb-2">Entre</span> <input type="number" name="startBudget" id="startBudget" class="form-control form-control-alternative" type="number" />
