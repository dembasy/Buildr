            ...
            <div class="pl-lg-4">
              ...
              <div class="col-lg-6">
                <div class="form-group has-error">
                  ...
                  <input type="text" name="firstname" id="firstname" <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?>  class="form-control form-control-alternative">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group has-error">
                  ...
                  <input type="email" name="email" id="email" <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?> class="form-control form-control-alternative">
              ...
              <div class="col-lg-6">
                <div class="form-group has-error">
                    ...
                    <input type="number" id="phoneNumber" name="phoneNumber" <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?> class="form-control form-control-alternative">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group has-error">
                    ...
                    <input type="text" name="firm" id="firm" <?= isset($lastname) ? 'value="' . $lastname . '"' : '' ?> class="form-control form-control-alternative">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group has-error">
                  ...
                  <input type="text" id="address" name="address" <?= isset($lastname) ? 'value="' . $address . '"' : '' ?>  class="form-control form-control-alternative " />
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="form-group has-error">
                  ...
                  <input type="number" name="postalCode" id="postalCode" <?= isset($lastname) ? 'value="' . $postalCode . '"' : '' ?> class="form-control form-control-alternative"/>
