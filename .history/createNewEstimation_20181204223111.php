                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <p class="text-danger"><?= isset($errorList['city']) ? $errorList['city'] : ''; ?></p>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="lastname">Quelle est votre budget ?</label>
                                    ...
                                    <p class="text-danger"><?= isset($errorList['firstname']) ? $errorList['lastname'] : ''; ?></p><label class="form-control-label mb-2 mb-2" for="startBudget">Quel est votre budget ?</label><br>                                            
