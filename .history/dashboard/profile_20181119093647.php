      ...
      <div class="bg-secondary shadow">
        ...
        <div class="card-body">
          ...
          <div class="pl-lg-4">
            ...
            <a type="submit" class="btn btn-default" id="save" name="save" >Enregistrer mes informations</a>
            <a type="submit" class="btn btn-primary"  name="modify" id="modify">Modifier mes informations</a>
            <a type="submit" href="profile.php?delete=1" class="btn btn-danger"  name="delete" id="idRemove">Supprimer mes informations</a>
          </div>
        </div>
      </form>
    </div>
