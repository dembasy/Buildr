      ...
      <div class="bg-secondary shadow">
        ...
        <div class="card-body">
          ...
          <div class="pl-lg-4">
            ...
            <input type="submit" class="btn" value="Enregistrer mes informations" id="save" name="save" />
            <input type="submit" class="btn btn-primary" value="Modifier mes informations"  name="modify" id="modify"/>
            <input type="submit" class="btn btn-danger" value="Supprimer mes informations" href="profile.php?delete=1" name="delete" id="idRemove"/>
          </div>
        </div>
      </form>
    </div>
