                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <?php if (!isset($_SESSION['isConnect'])) { ?>
                            <a class = "nav-link" href="http://buildr/dashboard/PRO/loginPro.php"><?= NAV_CONNECT ?></a>
                        </li>
                            <li class="divider"></li>
                        <?php 
                    } else { ?>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="http://buildr/dashboard/PRO/dashboardPro.php"><i class="fa fa-dashboard fa-fw"></i> Mes projets</a>
                        </li>
                        <li>
                            <a href="http://buildr/dashboard/PRO/profilePro.php"><i class="fa fa-edit fa-fw"></i> Mon profil</a>
                        </li>
                    </ul>
                </div>
            </div>
