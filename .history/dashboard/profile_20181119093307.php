      ...
      <div class="bg-secondary shadow">
        ...
        <div class="card-body">
          ...
          <div class="pl-lg-4">
            ...
            <a type="submit" class="btn" value="Enregistrer mes informations" id="save" name="save"></a>
            <a type="submit" class="btn btn-primary" value="Modifier mes informations"  name="modify" id="modify"></a>
            <a type="submit" class="btn btn-danger" value="Supprimer mes informations" name="delete" id="idRemove"></a>
          </div>
        </div>
      </form>
    </div>
