    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="#" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group"><br>
                                <label class="form-control-label mb-3" for="endBudget">ET </label><br>                   
                ...
                <input type="submit" class="btn btn-primary d-flex-center" value="Envoyer mes réponses" name="submitSurvey" />
            </fieldset>
        </form>
    </div>
        </div>
