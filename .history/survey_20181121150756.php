                ...
                <form action="#" method="POST">
                    <div class="pl-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group has-error">
                                    <label class="form-control-label mb-2" for="address">Quel est votre budget ?</label>
                                    <select name = "city" id = "city" >
                                        <option selected disabled>Veuillez séléctionner votre choix</option>
                                        <option selected>Maison</option>
                                        <option selected>Appartement</option>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group has-error">
                                    <label class="form-control-label mb-2" for="address">Avez-vous des précisions à apporter ?</label>
                                    <textearea id="address" name="address" class="form-control form-control-alternative " type="text"></textearea>
                                    <p class="text-danger"><?= isset($errorList['address']) ? $errorList['address'] : ''; ?></p>
                                </div>
                            </div>
                        </div>
