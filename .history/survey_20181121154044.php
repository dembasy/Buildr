                            ...
                            <div class="col-lg-12">
                                <div class="form-group has-error">
                                    ...
                                    <select name ="propertyTypes" id="propertyTypes" >
                                        ...
                                        <option name="room" value="1" selected>Maison</option>
                                        <option name="room" value="2" selected>Appartement</option>
                                        <option name="room" value="3" selected>Local</option>
                                        <option name="room" value="4" selected>Bureaux</option>
                                    </select>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group has-error">
                                    ...
                                    <select name = "budget" id = "budget" >
                                        <option name="room" selected disabled>Veuillez séléctionner votre choix</option>
                                        <option name="room" value="1" selected>Moins de 10 000 €</option>
                                        <option name="room" value="2" selected>Entre 10 000 € et 30 000 €</option>
                                        <option name="room" value="3" selected>Entre 30 000 € et 70 000 €</option>
                                        <option name="room" value="4" selected>Plus de 100 000€</option>
                                    </select>
