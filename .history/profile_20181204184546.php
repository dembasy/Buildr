            ...
            <form action="#" method="POST">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label for="name">Quelle est le nom que vous souhaitez donnez a votre projet?</label>
                        <input type="text" class="form-control" id="name" placeholder="La maison des Dupont" name="name" />
