                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-user fa-fw"></i> Bonjour <?= $_SESSION['firstname'] ?>
                                            ...
                                            <li>
                        <a href="estimations.php"><i class="fa fa-table fa-fw"></i> Mes estimations</a>
                    </li>
                    <li>
                        <a href="profile.php?id=<?= $_SESSION['id'] ?>"><i class="fa fa-edit fa-fw"></i> Mon profil</a>
                    </li>
                </ul>
                        <ul class="dropdown-menu dropdown-user">
                            <li class="nav-item dropdown">
                                ...
                                <li class="divider"></li>
                            <?php } else { ?>
                                <li><a class="dropdown-item" href="<?= $_SERVER['PHP_SELF'] ?>?action=disconnect"><i class="fas fa-sign-out-alt"></i> <?= NAV_DISCONNECT ?></a></li>
                            <?php }
                            ?>
