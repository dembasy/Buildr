...
include_once '../controllers/manageProjectsCtl.php';
?>
<!DOCTYPE html>
<html lang="en" class="full-height">
    <head>
        ...
        <title>Modification de mon questionnaire | Buildr</title>
        <!-- Font Awesome -->
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group has-error">
                                            ...
                                            <input id="area" name="area" class="form-control form-control-alternative" value="<?= $userProject->area ?>" type="number">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group has-error">                     
                                                <label class="form-control-label mb-2" for="postalCode"></label>
                                                <input type="number" name="postalCode" id="postalCode" value="" class="form-control form-control-alternative">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group has-error">
                                            ...
                                            <textarea id="moreInfos" name="moreInfos"rows="5" cols="10"><?= $userProject->moreInfos ?></textarea>
                                ...
                                <input type="submit" href="" class="btn btn-primary align-items-center" value="Modifier mes informations" name="modifyProject" id="modifyProject" />
                            </div>
                        </form>
                    </div>
                </div>
