                ...
                <form action="#" method="POST">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="lastname" id="lastname" class="form-control form-control-alternative deactivation col-lg-6" value="<?= $userProfile->lastname ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="firstname" id="firstname" class="form-control form-control-alternative deactivation col-lg-6" value="<?= $userProfile->firstname ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control form-control-alternative deactivation col-lg-6" value="<?= $userProfile->email ?>">
