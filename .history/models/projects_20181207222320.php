...
class projects extends database {
    ...
    public function getProjectInfosOnce() {
        ...
        $result = $this->db->prepare($query);
        // Le bindValue permet de mettre en lien les élements qui sont envoyé du controller grâce au marqueurs et les met en liens afin de les rentrés dans la base
