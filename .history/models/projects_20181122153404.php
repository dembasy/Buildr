...
class projects extends database
{
    ...
    {
        $query = 'INSERT INTO `d27PD_projects`(`address`, `area`, `startBudget`, `endBudget`, `date`, `moreInfos`, `idUsers`, `idPropertyTypes`, `idRooms`, `idCity`) '
            . 'VALUES (:room, :address, :area, :startBudget, :endBudget, :date, :moreInfos, :idUsers, :propertyTypes, :room, :city)';
        ...
        $result->bindValue(':room', $this->idUsers, PDO::PARAM_INT);
