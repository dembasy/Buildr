...
class projects extends database {
    ...
    {
        $PDOResult = $this->db->prepare('SELECT `d27PD_projects`.`id`,`d27PD_projects`.`address`, `d27PD_projects`.`startBudget`, `d27PD_projects`.`endBudget`, `d27PD_projects`.`moreInfos`, `d27PD_projects`.`idRoom`, `d27PD_projects`.`idPropertyTypes`, `d27PD_projects`.`idUsers`, `d27PD_projects`.`idCity`'
            . ' FROM `d27PD_projects`'
