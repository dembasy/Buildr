...
class projects extends database
{
    ...
    {
        $query = 'INSERT INTO `d27PD_projects`(`name`, `address`, `area`, `budget`, `date`, `moreInfos`, `idUsers`, `idPropertyTypes`) '
            . 'VALUES (:name, :address, :area, :budget, :date, :moreInfos, idUsers, :propertyTypes)';
