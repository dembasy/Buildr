...
class projects extends database {
    ...
    {
        $PDOResult = $this->db->prepare('SELECT `d27PD_projects`.`id`,`d27PD_projects`.`address`, `d27PD_projects`.`startBudget`, `d27PD_projects`.`endBudget`, `d27PG_users`.`moreInfos`, `d27PD_projects`.`idRoom`, `d27PD_projects`.`idPropertyTypes`, `d27PD_projects`.`idUsers`, `d27PJ_city`.`idCity`, `d27PG_users`.`idUsersType`  , `d27PJ_city`.`cityName`'
            . ' FROM `d27PD_projects`'
