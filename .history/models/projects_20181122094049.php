...
class projects extends database
{
    ...
    {
        $query = 'INSERT INTO `d27PD_projects`(`room`, `address`, `area`, `budget`, `date`, `moreInfos`, `idUsers`, `idPropertyTypes`) '
            . 'VALUES (:room, :address, :area, :budget, :date, :moreInfos, idUsers, :propertyTypes)';
