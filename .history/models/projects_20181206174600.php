...
class projects extends database {
    ...
    public function projectsInsertion() {
        ...
        //On integre les informations envoyé par le controller dans les attributs de la classe en passant par les marqueurs et en utilisant la fonction bindValue
    ...
    public function getProjects()
    {
        ...
        $query = 'SELECT `d27PD_projects`.`id`, `d27PD_projects`.`name`, `d27PD_projects`.`area`, `d27PD_projects`.`address`, `d27PD_projects`.`startBudget`, `d27PD_projects`.`endBudget`, `d27PD_projects`.`moreInfos`, `d27PA_rooms`.`room`, `d27PF_propertyTypes`.`type`, `d27PG_users`.`firstname`, `d27PJ_city`.`cityName` '
            . 'FROM `d27PD_projects` '
            // Inner Join permet de récupêrer uniquement les informations d'une tables qui est en liens avec une ou plusieurs autres tables et de récupérer les données qu'on a definit dans notre conditions
