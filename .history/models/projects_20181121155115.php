...
class users extends database
{
    ...
    {
        $query = 'INSERT INTO `d27PD_projects`(`id`, `area`, `budget`, `date`, `idUsers`, `idPropertyTypes`) '
            . 'VALUES (:id, :area, :budget, :date, `idUsers`, :idPropertyTypes)';
        ...
        $result->bindValue(':id', $this->lastname, PDO::PARAM_STR);
        $result->bindValue(':area', $this->firstname, PDO::PARAM_STR);
        $result->bindValue(':budget', $this->email, PDO::PARAM_STR);
        $result->bindValue(':date', $this->firm, PDO::PARAM_STR);
        $result->bindValue(':idUsers', $this->password, PDO::PARAM_STR);
        $result->bindValue(':idPropertyTypes', $this->address, PDO::PARAM_STR);
    ...
    public function projectsModifications()
    {
