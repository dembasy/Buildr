...
class users extends database
{
    ...
    public function getUsersInfos() {
        $PDOResult = 'SELECT `d27PG_users`.`id`,`d27PG_users`.`lastname`, `d27PG_users`.`firstname`, `d27PG_users`.`email`, `d27PG_users`.`password`, `d27PG_users`.`firm`, `d27PG_users`.`address`, `d27PG_users`.`phoneNumber`, `d27PJ_city`.`postalCode`, `d27PG_users`.`idUsersType`, `d27PJ_city`.`cityName` '
            . ' FROM `d27PG_users`'
