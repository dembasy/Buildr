			...
			<div class="mm-survey">
                ...
                <div class="mm-survey-question">
								...
								<div class="mm-survey-item">
									...
									<label for="radio17"><span></span><p>Moins de 10000€</p></label>
								</div>
								<div class="mm-survey-item">
									<input type="radio" id="radio18" data-item="4" name="radio4" value="2" />
									<label for="radio18"><span></span><p>Entre 10000 et 30000€</p></label>
								</div>
								<div class="mm-survey-item">
									<input type="radio" id="radio19" data-item="4" name="radio4" value="3" />
									<label for="radio19"><span></span><p>Entre 30000 et 100000€</p></label>
								</div>
								<div class="mm-survey-item">
									<input type="radio" id="radio20" data-item="4" name="radio4" value="4" />
									<label for="radio20"><span></span><p>Entre 100000 et 500000€</p></label>
								</div>
								<div class="mm-survey-item">
									<input type="radio" id="radio21" data-item="4" name="radio4" value="4" />
									<label for="radio21"><span></span><p>Plus de 500000€</p></label>
								</div>
								<div class="mm-survey-item">
