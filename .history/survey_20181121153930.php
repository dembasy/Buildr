...
include_once 'controllers/surveyCtl.php';
?>
<div class="container">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group has-error">
                                    ...
                                    <select name ="propertyTypes" id="propertyTypes" >
                                        <option name="room" value="1" selected disabled>Veuillez séléctionner votre choix</option>
                                        <option name="room" value="2" selected>Maison</option>
                                        <option name="room" value="3" selected>Appartement</option>
                                        <option name="room" value="4" selected>Local</option>
                                        <option name="room" value="5" selected>Bureaux</option>
                                    </select>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group has-error">
                                    ...
                                    <select name = "budget" id = "budget" >
                                        <option name="room" value="1" selected disabled>Veuillez séléctionner votre choix</option>
                                        <option name="room" value="2" selected>Moins de 10 000 €</option>
                                        <option name="room" value="3" selected>Entre 10 000 € et 30 000 €</option>
                                        <option name="room" value="4" selected>Entre 30 000 € et 70 000 €</option>
                                        <option name="room" value="5" selected>Plus de 100 000€</option>
                                    </select>
