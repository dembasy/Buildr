            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-user fa-fw"></i><?= sprintf(NAV_WELCOME,$_SESSION['firstname']) ?>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <?php if (!isset($_SESSION['isConnect'])) { ?>
                            ...
                            <li class="divider"></li>
                        <?php } else { ?>
                                <li><a class="dropdown-item" href="<?= $_SERVER['PHP_SELF'] ?>?action=disconnect"><i class="fas fa-sign-out-alt"></i> <?= NAV_DISCONNECT ?></a></a>
                        <?php }
                        ?>
                        </li>
                    </ul>
