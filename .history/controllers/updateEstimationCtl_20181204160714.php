...
// Si l'input n'est pas vide
    ...
    if (isset($_SESSION['id'])) {
        $project = new projects();
        $project->id = $_SESSION['id'];
        $userProject = $project->getProjectInfos();
    }
}
...
//if (isset($_POST['idDeleteProject'])) {
//    $deleteProject = new projects();
//    $deleteProject->idUsers = $_SESSION['id'];
//    $deleteResult = $deleteProject->removeProject();
