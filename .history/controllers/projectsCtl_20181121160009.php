...
//condition pour le formulaire
    if (isset($_POST['submitSurvey'])) {
        ...
        if (!empty($_POST['area'])) {
            if (preg_match($regexName, $_POST['area'])) {
                $lastname = htmlspecialchars($_POST['area']);
            } else {
                $errorList['roareaom'] = 'La saisie de votre nom est invalide';
            }
        } else {
            $errorList['area'] = 'Veuillez indiquer votre nom';
        }
