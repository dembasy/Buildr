...
// Si le bouton submitRegister est envoyé 
    if (isset($_POST['submitRegister'])) {
        ...
        if (!empty($_POST['lastname'])) {
            ...
            // On indique à l'utilisateur que son nom est requis pour l'inscription
       ...
       // On test si l'input n'est pas vide firstname 
        if (!empty($_POST['firstname'])) {
            ...
            // On indique à l'utilisateur que son prénom est requis pour l'inscription
       ...
       // On test si l'input n'est pas vide firstname 
        if (!empty($_POST['address'])) {
            ...
            // On indique à l'utilisateur que son address est requis pour l'inscription
