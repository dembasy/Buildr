    ...
    if (isset($_POST['submitRegister'])) {
        ...
        if (!empty($_POST['lastname'])) {
            ...
            if (preg_match($regexName, $_POST['lastname'])) {
                // Hydratation de la valeur de l'inputusersType
        ...
        if (!empty($_POST['firm']) && ($_POST['usersType'] == 2)) {
            // On vérifie avec le preg match si la valeur respecte bien les valeurs que l'ont attends si c'est le casusersType
            ...
            // Sinon si l'input usersType est  vide et qu'il correspond bien à 2usersType
        ...
        if (count($errorList) == 0) {
            ...
            if (!$user->usersRegister()){
                $errorList = 'Une problème est survenue';
            };
        }
