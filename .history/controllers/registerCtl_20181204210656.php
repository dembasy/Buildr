...
// Si le bouton submitRegister est envoyé 
    if (isset($_POST['submitRegister'])) {
       ...
       // On test si l'input n'est pas vide usersType 
        if (!empty($_POST['usersType'])) {
         ...
         // On test si l'input n'est pas vide usersType et que l'userType est == à 2 
       ...
       // On test si l'input n'est pas vide postalCode 
