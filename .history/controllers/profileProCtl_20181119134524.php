...
if (isset($_POST['postalCodeSearch'])) {
    ...
    if (isset($_POST['modify'])) {
        ...
        if (!empty($_POST['firm'])) {
            if (preg_match($regexNumberLetter, $_POST['firm'])) {
                $profile->firm = htmlspecialchars($_POST['firm']);
            } else {
                $errorList['firm'] = 'La saisie de votre ville est invalide';
            }
        } else {
            $errorList['firm'] = 'Veuillez indiquer votre ville';
        }
...
$userProfile = $profile->getFirmInformations();
