...
//condition pour le formulaire
    if (isset($_POST['submitRegister'])) {
        ...
        if (!empty($_POST['usersType'])) {
            if (preg_match($regexNumber, $_POST['usersType'])) {
                $address = htmlspecialchars($_POST['usersType']);
            } else {
                $errorList['usersType'] = 'La saisie de votre adresse est invalide';
            }
        } else {
            $errorList['usersType'] = 'Veuillez indiquer votre adresse';
        }
